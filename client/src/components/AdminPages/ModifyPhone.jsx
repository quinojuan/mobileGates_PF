        ...
        <form id="miForm">
          ...
          <div class="row mt-3">
            ...
            <div class="col">
              ...
              <input
                ...
                onChange={handleChange}
                class="form-control is-valid"
                placeholder={myPhone[0].operative_system}
          ...
          <div class="row mt-3">
            <div class="col">
              ...
              <input
                ...
                onChange={handleChange}
                class="form-control is-valid"
                placeholder={myPhone[0].frontal_camera}
                aria-label="First name"
              ></input>
            </div>
            <div class="col">
              ...
              <input
                ...
                onChange={handleChange}
                class="form-control is-valid"
                placeholder={myPhone[0].main_camera}
                aria-label="Last name"
              ></input>
            </div>
            <div class="col">
          ...
          <div class="row mt-1">
            <div class="col">
              ...
              <input
                class="form-control is-valid"
                placeholder={myPhone[0].description}
