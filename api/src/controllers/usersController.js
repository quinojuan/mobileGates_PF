...
const createUser = async (req, res) => {
  try {
    const {email, reloadUserInfo:{passwordHash} } = req.body // desestructuro un obj con propiedades anidadas
    ...
    if (validation) {
      ...
      const newUser = await Users.findOrCreate({ where: { email, password: passwordHash} });
